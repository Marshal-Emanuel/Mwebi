...
class Themify_Twitter extends WP_Widget {
	...
	function themify_shortcode_twitter( $atts, $content = null ) {
		...
		if ( $atts['type'] === 'type-timeline' ) {
            ...
            return "<a class='twitter-timeline' {$data_chrome} data-show-count='{$atts['show_count']}' data-show-replies='$show_replies' data-height='{$atts['timeline_height']}' data-width='{$atts['timeline_width']}'
